...
Im Rahmen dieser Studienarbeit wird Strapi als API (im Folgenden \glqq Backend\grqq{} genannt) verwendet, um Blogartikel zu verwalten. Eine detaillierte Betrachtung des CMS erfolgt in Kapitel \ref{sec:struktur-backend}.
